...
import { Search, Filter, MoreHorizontal, Eye, Edit, Truck, RefreshCw } from "lucide-react";
...
const Orders = () => {
  ...
  const filteredOrders = (ordersJson as any[]).filter(order =>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">$157.50</div>
            <p className="text-xs text-muted-foreground">
              +7% increase
            </p>
          </CardContent>
