...
const Products = () => {
  ...
  const filteredProducts = (productsJson as any[]).filter(product =>
            ...
            <TableBody>
              {filteredProducts.map((product: any) => (
                <TableRow key={product.id}>
                  ...
                  <TableCell>{product.revenue ?? `$${product.price ?? 0}`}</TableCell>
                  <TableCell>
                    <Badge variant="secondary">Active</Badge>
                  </TableCell>
                  <TableCell>
                    <span className={(product.change ?? '').startsWith('+') ? "text-success" : "text-destructive"}>
                      {product.change ?? '+0%'}
                    </span>
                  </TableCell>
